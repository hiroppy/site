...
import { ARTICLE_PREVIEW_EVENT } from "../../utils/feedle/subscriptionStore";
      ...
      <div class="grid gap-6 lg:grid-cols-3">
        <div class="lg:col-span-1">
          {article?.image ? (
            ...
            <div class="mb-4 flex h-48 items-center justify-center rounded-lg bg-gradient-to-br from-gray-100 to-gray-200">
          ...
          <div class="mt-4 flex flex-wrap items-center gap-4 text-sm text-gray-500">
            ...
            <time class="text-xs">{formatDate(article?.published)}</time>
          </div>
        ...
        <div class="lg:col-span-2">
          <div class="mb-6">
            ...
            <p class="leading-relaxed whitespace-pre-wrap text-gray-600">
              {summaryText}
            </p>
          </div>
