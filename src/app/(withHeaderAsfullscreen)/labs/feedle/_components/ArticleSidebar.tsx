...
} from "../_utils/feedle/subscriptionStore";
...
export function ArticleSidebar({
  ...
  return (
    <>
      <div
        id="sidebar-backdrop"
        className={`pointer-events-none fixed inset-0 z-40 bg-black/50 transition-opacity duration-300 ease-in-out md:hidden ${backdropClass}`}
      />
        ...
        <div className="flex h-full flex-col overflow-hidden">
          ...
          <div className="flex flex-1 flex-col overflow-hidden">
            ...
            <div className="flex-1 overflow-y-auto p-2">
              <div id="sidebar-services" className="space-y-1">
                <NavItem
