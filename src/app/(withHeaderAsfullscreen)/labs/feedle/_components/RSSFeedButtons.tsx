...
import {
  ...
  RSS_FEED_KINDS,
  generateRSSUrl,
} from "../_utils/feedle/feedleConfig";
...
export function RSSFeedButtons({ currentType, lastHarvested }: Props) {
          ...
          <div className="flex flex-wrap gap-2">
            {RSS_FEED_KINDS.map((kind) => (
              <button
                ...
                onClick={() =>
                  handleCopy(generateRSSUrl(currentType, kind.key), kind.label)
                }
              >
