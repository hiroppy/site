...
![](/images/blog/nodejs-performance/devtool.png)

先程の、`cont`は右ツールバーの一番左のボタンを押すことにより進めることができます。

![](/images/blog/nodejs-performance/devtool2.png)

進むと以下のようになります。 簡単にファイルから読み取った中身(`data`)が表示されました。

![](/images/blog/nodejs-performance/devtool3.png)
...
![](/images/blog/nodejs-performance/breakpoint.png)
...
![](/images/blog/nodejs-performance/profile.png)
...
![](/images/blog/nodejs-performance/flamegraph.png)
...
![](/images/blog/nodejs-performance/memory.png)

<br />

![](/images/blog/nodejs-performance/memory2.png)
...
![](/images/blog/nodejs-performance/clinic.png)
...
![](/images/blog/nodejs-performance/bubbleprof.png)

userland, dependencies, Node Core でそれぞれ処理にかかった時間がわかります。
また、非同期処理の実行回数と時間もわかります。

![](/images/blog/nodejs-performance/async.png)
