      ...
      (async () => {
        ...
        if (document.querySelector(id).children.length === 0) {
          const { Runtime, Inspector } =
            await import("https://cdn.jsdelivr.net/npm/@observablehq/runtime@4/dist/runtime.js");
          const { default: define } =
            await import("https://api.observablehq.com/@d3/hierarchical-edge-bundling.js?v=3");
