...
export async function OG({ url }: Props) {
  ...
  return (
    <a
      ...
      aria-label={title}
      className="group my-6 block overflow-hidden rounded-lg border border-gray-200 bg-white transition-all duration-200 hover:border-blue-500 hover:shadow-md"
    >
